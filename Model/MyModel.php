...
class MyModel {
    ...
    function InsertData($tbl, $data, $name, $email) {

        $check=mysqli_query($this->connection,"SELECT * FROM employee WHERE `name`= '$name' OR `email`='$email'");
      ...
      echo "customer exists";
        ...
        $vals = implode("','", $data);
        $InsertSQL = "INSERT IGNORE INTO $tbl($clms)VALUES('$vals')";
        //echo $InsertSQL; exit;
